      ...
      <div className="flex-1 overflow-hidden">
        <MapProvider>
          <PanelGroup direction="horizontal">
            ...
            {/* Middle Column - Map + Nearby List (vertically resizable) */}
            <Panel defaultSize={60}>
              <PanelGroup direction="vertical">
                ...
                {/* Invisible drag handle — widens on hover for easy grabbing */}
                <PanelResizeHandle className="h-1 cursor-row-resize bg-transparent hover:bg-violet-500/20 transition-colors" />
